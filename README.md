...
- GitHub Actions can deploy Wasmer through `.github/workflows/deploy-wasmer.yml`; add a repository secret named `WASMER_TOKEN`, then run **Actions → Deploy Wasmer → Run workflow**.
