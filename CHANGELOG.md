...
- Bumped the Wasmer package version to `0.1.1` so GitHub Actions can publish a new immutable package release.
...
- Marked GitHub Actions Wasmer deployments as private to match private package publishing requirements.
...
- Removed the unsupported Wasmer CLI `--name` deploy argument from the GitHub Actions workflow.
