...
- **Admin School Information, DepEd Jurisdiction & Sidebar Collapse**:
  ...
  - Hotfixed desktop sidebar toggle button collapsing and restoring in [`assets/js/main.js`](file:///c:/laragon/www/attendance-and-academic-management-system/assets/js/main.js) and [`assets/css/main.css`](file:///c:/laragon/www/attendance-and-academic-management-system/assets/css/main.css), centering logos and hiding nav text, badges, and system footer text cleanly in collapsed mode.
