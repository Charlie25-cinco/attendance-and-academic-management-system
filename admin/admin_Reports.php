...
function buildFilterParams($dateFrom, $dateTo, $classId, $gradeLevel, $section, $status, $topN = 10) {
    return \BshsAms\Report\ReportFilterHelper::buildFilterParams((string)$dateFrom, (string)$dateTo, (int)$classId, (int)$gradeLevel, (string)$section, (string)$status, (int)$topN);
}

function getStatusOptions($type) {
    return \BshsAms\Report\ReportFilterHelper::getStatusOptions((string)$type);
}
